 ...
 * \param[in] p_fichP chaîne de caractères représentant le fichier source dans lequel a eu lieu l'erreur
 * \param[in] p_prmLigne un entier représentant la ligne où a eu lieu l'erreur
 * \param[in] p_msgP Message décrivant l'erreur
 * \param[in] p_exprP Test logique qui a échoué
 */
